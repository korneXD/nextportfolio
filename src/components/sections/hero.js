...
export default function HeroLayout() {
    ...
    return (
        <section className="flex justify-center items-center h-screen w-full bg-black relative p-4">
            ...
            <div data-scroll data-scroll-speed="0.1" className="flex z-10 justify-center px-10 py-10 items-center md:items-start w-full md:w-fit h-fit absolute bottom-10 left-0 flex-col">
                <span className="text-gray-200 uppercase text-md md:text-lg tracking-wider text-left w-full px-8 italic">Web designer</span>
                <h1 className="text-white tracking-tighter text-5xl  md:text-7xl" style={{ fontFamily: "Arial Black, Arial, sans-serif" }}
                >
