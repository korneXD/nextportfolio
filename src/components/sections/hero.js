    ...
    return (
        <section className="flex justify-center items-center h-screen w-full bg-black relative p-4">
            ...
            <div data-scroll data-scroll-speed="0.05" className="flex z-10 justify-center px-10 py-10 items-center md:items-start w-full md:w-fit h-fit absolute bottom-10 left-0 flex-col">
                <span className="text-gray-200 uppercase text-md md:text-lg tracking-wider text-left w-full px-8 italic whitespace-nowrap">Web designer</span>
                ...
                >
                    <span className="inline-block transform skew-x-6">KOR</span>
                    <span className="inline-block transform -skew-x-8">ESZ</span>
                    <span className="block whitespace-nowrap">
                        <span className="inline-block transform -skew-x-12">WEB</span>
                        <span className="inline-block transform">DES</span>
                        <span className="inline-block transform skew-x-12">IGN</span>
                    </span>
                </h1>
            </div>
            ...
            <span ref={rightText} className="text-white z-10 absolute text-sm md:text-md bottom-4 right-4 inline-block uppercase tracking-wide">{new Date().getFullYear()} © koresz.hu</span>
        </section>
    );
}